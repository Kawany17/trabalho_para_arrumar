    ...
    <body>
        ...
        <main>
            <section class="produto">
                ...
                <div>
                    <img src="../imagens/ladrao.png" alt="Produto Listrada Zebra">
                </div>
                <ul>
                    <li><div><h2>Perc Jackson e o ladrão de raios</h2></div></li>
                    <li><p>O Ladrão de Raios é um belo pontapé no universo que o Riordan criou. Apresenta Percy, um garoto de doze anos que só está tentando sobreviver a mais um ano escolar regado a bullies e problemas com notas, e então a reviravolta de descobrir que não é nem um pouco comum, na verdade está destinado a grandes feitos heroicos, sendo o filho de um deus grego e tal.</p></li>
                   
                    <li><h3Rick Riordan></h3></li>
