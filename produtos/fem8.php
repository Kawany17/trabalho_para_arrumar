    ...
    <body>
        ...
        <main>
            <section class="produto">
                ...
                <div>
                    <img src="../imagens/coo.jpeg" alt="Produto Listrada Zebra">
                </div>
                <ul>
                    <li><div><h2>uma segunda chance</h2></div></li>
                    <li><p>Uma segunda chance: Depois de passar cinco anos na prisão após um trágico acidente, Kenna Rowan retorna à cidade onde tudo deu errado, esperando poder viver ao lado da filha pequena. Mas agora os abismos criados por Kenna parecem instransponíveis.</p></li>
