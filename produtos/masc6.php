    ...
    <body>
        ...
        <main>
            <section class="produto">
                ...
                <div>
                    <img src="../imagens/acordo.jpg" alt="Produto Listrada Zebra">
                </div>
                <ul>
                    <li><div><h2>O acordo</h2></div></li>
                    <li><p>O Acordo Quando o filho de John Matthews é acusado e preso por um crime que não cometeu, sendo este envolvimento com drogas, o homem fica desesperado e aceita qualquer coisa para tirar seu filho da cadeia.</p></li>
                    
                    <li><h3>Autora: Elle Kennedy</h3></li>
